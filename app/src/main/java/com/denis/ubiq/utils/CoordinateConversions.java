...
public class CoordinateConversions {
    ...
    public static double[] xyzToLatLonRadians( double[] xyz ) {
        ...
        double tanPhi = ( z + ( ePrimeSquared * b * ( Math.pow( Math.sin( BZero ), 3 ) ) ) ) / ( W - ( a * eSquared * ( Math.pow( Math.cos( BZero ),
                                                                                                                                  3 ) ) ) );
         ...
         */
        rSubN = ( a * a ) / Math.sqrt( ( ( a * a ) * ( Math.cos( phi ) * Math.cos( phi ) ) + ( ( b * b ) * ( Math.sin( phi )
                                                                                                             * Math.sin( phi ) ) ) ) );
